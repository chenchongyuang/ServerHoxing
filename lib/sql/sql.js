class SQL {
    ...
    loginSQL(o,field1,field2){
    	return "SELECT `"+ field1 +"`,`"+ field2 +"`,`uname` , `uid` FROM `t_reged` WHERE `"+ field1 +"` = '"+ o[field1] +"' AND `"+ field2 +"` = '"+ o[field2] +"'";
    }
    //登陆成功修改用户的状态
   ...
   //首页数据查询
    ...
    shoppingSQL(o){
        ...
        "INSERT INTO `t_shopping` (`image` , `price` , `sum` , `name` , `uid`) VALUES ('"+ o.image +"','"+ o.price +"','"+ o.sum +"','"+ o.name +"','"+ o.uid +"')"
        ];
    }
    //退货数据查询
    returnsSQL(){
    ...
    //修改个人资料
    mine_dataSQL(o,field){
        return "UPDATE `t_reged` SET `"+ field +"` = '"+ o[field] +"' WHERE `uid` = '"+ o.uid +"'";
    }
}
